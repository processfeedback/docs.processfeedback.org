...
**[Option 2: Create a special editor for your class](./option-create-custom-editor.md)**    
→ When to Use: Recommended approach for most courses  
→ Difficulty: Moderate  
→ Key Feature: Students see the course name in the editor

**[Option 3: Create assignments in Process Feedback](./option-create-assignment.md)**  
